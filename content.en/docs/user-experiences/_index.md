...
Each page in this book is a task that can be attempted to learn a core skill required of Interaction Designers. There are multiple workbooks provided for different core skills: User Experience Design (UX), User Interface Design (UI), Usability Testing, and Prototyping. To attempt a task or if you have been assigned one by your tutor, navigate to the appropriate section number (e.g. 2_.1 Elements of Interaction_) using the **_table of contents_** on the right/left and read through the task. Some tasks may come with additional readings, software to download, questions to answer, and links provided. Additional resources are provided at the end in a **_Resources_** section. As you complete tasks from this workbook, remember to keep track in your process journals as any activity you do will count towards participation in this course.
